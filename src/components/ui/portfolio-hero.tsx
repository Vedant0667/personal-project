...
const NOW: { label: string; value: string }[] = [
  { label: "Building", value: "Stowr, Shelter Aid" },
      ...
      <main className="relative mx-auto flex min-h-screen max-w-[78rem] flex-col justify-center px-5 pb-16 pt-28 sm:px-8 lg:px-10">
        <div className="grid grid-cols-1 items-end gap-12 lg:grid-cols-12 lg:gap-10">
          ...
          <div className="order-2 lg:order-1 lg:col-span-7">
            ...
            <RevealText
              as="p"
              text="I'm a business administration freshman at UT Austin's McCombs School, and most of my free time still goes into building software. I also run Shelter Aid TX, a shoe-donation nonprofit in Dallas that's collected 14,000+ pairs of shoes for those in need."
              step={20}
              delay={760}
