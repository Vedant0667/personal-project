...
export const metadata: Metadata = {
  ...
  description: "Vedant Subramanian is a business administration freshman at UT Austin who builds software and runs Shelter Aid TX, a Dallas shoe-donation nonprofit that has collected 8,000+ pairs of shoes for those in need.",
